...
- Env hints: `BARO_I2C_ADDR`, `BARO_INIT_RETRIES`, `ELECTRO_I2C_ADDR`, `IMU_I2C_ADDR`, `IMU_ENABLE_FEATURE_ATTEMPTS`, `GPS_I2C_ADDR`, `GPS_I2C_READ_CHUNK` (default 32, u-blox FIFO burst), `GPS_I2C_INIT_RETRIES`, `GPS_I2C_INIT_DELAY_SEC`, `GPS_USE_UART`, `GPS_DEVICE`, `GPS_BAUD`, `DISTANCE_I2C_ADDR`, `DISTANCE_TFL_TRIGGER`.
