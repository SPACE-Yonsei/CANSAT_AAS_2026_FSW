...
def terminate_FSW():
    ...
    termination_message = msgstructure.fill_msg(appargs.MainAppArg.AppID, appargs.MainAppArg.AppID, appargs.MainAppArg.MID_TerminateProcess, "")
    if termination_message is None:
       events.LogEvent(appargs.MainAppArg.AppName, events.EventType.error, "Failed to create termination message")
       return
